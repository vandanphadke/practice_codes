 ...
 *
 * The strength of any village on row larger than one (2<=r<=N) is stronger or equal to the strength
 * of village which is exactly above it. The strength of any village on column larger than one
 * (2<=c<=M) is stronger or equal to the strength of vilage which is exactly to its left.
...
public class KingdomWar {
    public static int returnMaxStrength(List<List<Integer>> arr){
